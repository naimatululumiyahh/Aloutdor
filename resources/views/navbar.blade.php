...
<nav class="bg-white shadow-md p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            <a href="{{ route('konten') }}"><h1 class="text-3xl font-bold text-red-400">AL<span class="text-gray-700">outdor</span></h1></a>
            <div class="relative">
        ...
        <div class="flex items-center space-x-4 relative">
            ...
            <div class="relative">
                ...
                <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                    <a href="{{ route('profile') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Lihat Profil</a>
